...
export const ui: Record<Lang, UiStrings> = {
  ar: {
    ...
    iqd: 'د.ع',
    heroEyebrow: 'تحديث مباشر من السوق',
    heroTitle: 'سعر الصرف في العراق',
    heroSubtitle: 'دولار ودينار — شراء ومبيع الآن',
    ...
    faq5q: 'أين أتابع سعر الصرف في العراق اليوم؟',
    faq5a:
      'على dinar-now يمكنك متابعة سعر الصرف في العراق لحظة بلحظة: سعر الدولار شراء ومبيع، العملات الأخرى، وسعر الذهب مع حاسبة تحويل فورية.',
    ...
    keywords:
      'سعر الصرف في العراق, سعر الصرف في العراق الآن, سعر الدولار في العراق, سعر صرف الدينار العراقي, سعر الذهب في العراق, المصرف المركزي العراقي, تحويل العملات, دولار دينار',
    seoIraqTitle: 'سعر الصرف في العراق',
    seoIraqBody:
      'سعر الصرف في العراق هو المرجع اليومي لسعر الدولار والدينار والعملات الأجنبية لدى الصرافين. على dinar-now نعرض سعر الصرف في العراق شراءً ومبيعاً لحظة بلحظة، مع تغطية بغداد وأربيل والبصرة وباقي المحافظات، وحاسبة تحويل فورية.',
    seoGoldTitle: 'سعر الذهب مع سعر الصرف في العراق',
    seoGoldBody:
      'إلى جانب سعر الصرف في العراق، نعرض سعر الذهب (عيارات محلية وأونصة) لمساعدتك على مقارنة السوق قبل الشراء أو البيع.',
    seoCbiTitle: 'المصرف المركزي العراقي والأسعار المرجعية',
    seoCbiBody:
      'المصرف المركزي العراقي يصدر أسعاراً رسمية. dinar-now يعرض سعر الصرف في العراق من السوق الموازي كمرجع يومي، مع روابط للمصادر الرسمية.',
    titleFallback: 'سعر الصرف في العراق | سعر الدولار والذهب الآن | dinar-now',
    descriptionFallback:
      'سعر الصرف في العراق الآن: سعر الدولار مقابل الدينار العراقي شراء ومبيع، سعر الذهب، وحاسبة تحويل العملات — مرجع يومي محدّث.',
    titleWithPrice: (sell: number) =>
      `سعر الصرف في العراق | الدولار ${sell} | dinar-now`,
    descriptionWithPrice: (buy: number, sell: number) =>
      `سعر الصرف في العراق الآن (لكل 100$): شراء ${buy} ومبيع ${sell}. تابع سعر الدولار والذهب وحوّل العملات فوراً.`,
  },
  en: {
